(function (global, factory) {
   ...
   */
   ...
   function globalError(err, promise) {
       ...
       if (rv !== false) try {
           Promise$1.on.error.fire(err, promise); // TODO: Deprecated and use same global handler as bluebird.
       } catch (e) {}
   }
   ...
   */
   ...
   function Dexie(dbName, options) {
       ...
       function updateTablesAndIndexes(oldVersion, trans, idbtrans) {
           ...
           function runQueue() {
               return queue.length ? Promise$1.resolve(queue.shift()(trans.idbtrans)).then(runQueue) : Promise$1.resolve();
           }
       ...
       */
       ...
       this._whenReady = function (fn) {
           return new Promise$1(fake || openComplete || PSD.letThrough ? fn : function (resolve, reject) {
               if (!isBeingOpened) {
                   if (!autoOpen) {
       ...
       this.transaction = function (mode, tableInstances, scopeFunc) {
           ...
           function enterTransactionScope(resolve) {
               var parentPSD = PSD;
               resolve(Promise$1.resolve().then(function () {
   ...
   function awaitIterator(iterator) {
       ...
       function step(getNext) {
           return function (val) {
               ...
               return next.done ? value : !value || typeof value.then !== 'function' ? isArray(value) ? Promise$1.all(value).then(onSuccess, onError) : onSuccess(value) : value.then(onSuccess, onError);
           };
       }
       ...
       async: function (generatorFn) {
           return function () {
               try {
                   ...
                   if (!rv || typeof rv.then !== 'function') return Promise$1.resolve(rv);
                   return rv;
               } catch (e) {
                   return rejection(e);
               }
